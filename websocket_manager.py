...
class ConnectionManager:
    ...
    async def disconnect(self, user_id: str):
        ...
        if partner_id:
            ...
            # Notify partner
            await self.send_personal_message(json.dumps({"type": "partner-disconnected"}), partner_id)
    ...
    def get_online_count(self):
        return len(self.waiting_users) + len(self.connected_pairs)
    ...
    async def handle_next(self, user_id: str):
        ...
        if partner_id:
            ...
            del self.connected_pairs[partner_id]
            # Notify partner
            await self.send_personal_message(json.dumps({"type": "partner-next"}), partner_id)
